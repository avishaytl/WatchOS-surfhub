...
class MotionManager: ObservableObject {
    ...
    private let motionProcessingQueue = DispatchQueue(
        label: "com.spoteq.motion.processing",
        qos: .userInitiated
    )
    ...
    private let altimeterControlQueue = DispatchQueue(
        label: "com.spoteq.altimeter.control",
        qos: .userInitiated
    )
    ...
    private let pipelineHealthQueue = DispatchQueue(label: "com.spoteq.motion.health", qos: .utility)
