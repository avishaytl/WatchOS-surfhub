...
> Single-source summary of the SPOTEQ watchOS jump-detection algorithm, derived from the
> actual Swift implementation and the recorded sensor logs.
>
> **Primary sources**
> - Algorithm: [SPOTEQ Watch App/Services/JumpDetector.swift](../SPOTEQ%20Watch%20App/Services/JumpDetector.swift)
> - Models & config: [SPOTEQ Watch App/Models/Session.swift](../SPOTEQ%20Watch%20App/Models/Session.swift)
> - Sensor capture: [SPOTEQ Watch App/Services/SessionLogger.swift](../SPOTEQ%20Watch%20App/Services/SessionLogger.swift)
...
Defined in [Session.swift](../SPOTEQ%20Watch%20App/Models/Session.swift). One sample per sensor tick (~50 Hz active).
...
Defined as `enum JumpState` in [JumpDetector.swift](../SPOTEQ%20Watch%20App/Services/JumpDetector.swift).
...
through `JumpDetectionConfig.shared` in [Session.swift](../SPOTEQ%20Watch%20App/Models/Session.swift).
...
Defined in [Session.swift](../SPOTEQ%20Watch%20App/Models/Session.swift).
