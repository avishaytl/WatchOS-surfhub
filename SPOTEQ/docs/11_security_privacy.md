...
SPOTEQ handles sensitive user data (location, activity patterns) and must prioritize security and privacy. This document covers data protection, authentication security, and privacy best practices.
...
#### iOS (Keychain)
```swift
// apps/mobile/ios/SPOTEQ/KeychainManager.swift
import Security
...
import { Sport } from '@spoteq/shared-types';
...
- Right to delete
- Right to opt-out of data "sale" (N/A for SPOTEQ - we don't sell data)

### Privacy Policy Template

```markdown
# SPOTEQ Privacy Policy
...
Questions? Email: privacy@spoteq.app
```
...
Contact: mailto:security@spoteq.app
