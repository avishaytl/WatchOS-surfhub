...
> מסמך זה הוחלף ואינו משקף עוד את המימוש הנוכחי. הגרסה העדכנית,
> הוויזואלית והמלאה נמצאת כאן:
> [מנוע 13 - תיאור מקצה לקצה (PDF)](./v13-engine-report/V13_Engine_13_End_to_End_HE.pdf).
