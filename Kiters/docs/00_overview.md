...
**iSurf** is a cross-platform wind sports tracking system designed for kiteboarding, windsurfing, wingfoiling, and surfing. The system provides real-time session tracking with advanced jump detection, speed metrics, and GPS route mapping.
