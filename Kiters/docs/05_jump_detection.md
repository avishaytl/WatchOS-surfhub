...
The jump detection algorithm is the **most critical component** of iSurf. It must accurately detect jumps in challenging conditions: water spray, vibrations, board chop, and varying jump styles (boosted vs. unhooked, rotations, etc.).
