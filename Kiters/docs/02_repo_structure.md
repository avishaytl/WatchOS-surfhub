...
iSurf uses a **monorepo** to share code and types across all platforms while keeping platform-specific code isolated.
...
echo "Setting up iSurf monorepo..."
