...
- מדידות מקומיות: `Kiters/Tools/JumpReplay --dump-samples` על `log_20260714_135926_BF228815.kslog` ו-`log_v14_20260717_145840_FD5F91F0.kslog` (ראו §1, §5, §11 — מספרים גולמיים בתוך המסמך, לא בקובץ נפרד).
